...
PROTOBUF_CONSTEXPR Address::Address(
    ...
    /*decltype(_impl_.m_addr_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
const uint32_t TableStruct_address_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Aoqi::Address, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Aoqi::Address, _impl_.num_),
  PROTOBUF_FIELD_OFFSET(::Aoqi::Address, _impl_.m_addr_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Aoqi::Address)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Aoqi::_Address_default_instance_._instance,
};

const char descriptor_table_protodef_address_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\raddress.proto\022\004Aoqi\"&\n\007Address\022\013\n\003num\030"
  "\001 \001(\005\022\016\n\006m_addr\030\002 \001(\014b\006proto3"
  ;
...
Address::Address(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:Aoqi.Address)
}
Address::Address(const Address& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  Address* const _this = this; (void)_this;
  new (&_impl_) Impl_{
      decltype(_impl_.m_addr_){}
    , decltype(_impl_.num_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.m_addr_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.m_addr_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_m_addr().empty()) {
    _this->_impl_.m_addr_.Set(from._internal_m_addr(), 
      _this->GetArenaForAllocation());
  }
  _this->_impl_.num_ = from._impl_.num_;
  // @@protoc_insertion_point(copy_constructor:Aoqi.Address)
}
...
Address::~Address() {
  // @@protoc_insertion_point(destructor:Aoqi.Address)
...
void Address::Clear() {
// @@protoc_insertion_point(message_clear_start:Aoqi.Address)
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          auto str = _internal_mutable_m_addr();
...
uint8_t* Address::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:Aoqi.Address)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // bytes m_addr = 2;
  if (!this->_internal_m_addr().empty()) {
    target = stream->WriteBytesMaybeAliased(
        2, this->_internal_m_addr(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Aoqi.Address)
  return target;
}

size_t Address::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Aoqi.Address)
  size_t total_size = 0;
...
void Address::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:Aoqi.Address)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;

  if (!from._internal_m_addr().empty()) {
    _this->_internal_set_m_addr(from._internal_m_addr());
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:Aoqi.Address)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Address::InternalSwap(Address* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.m_addr_, lhs_arena,
      &other->_impl_.m_addr_, rhs_arena
  );
...
template<> PROTOBUF_NOINLINE ::Aoqi::Address*
Arena::CreateMaybeMessage< ::Aoqi::Address >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Aoqi::Address >(arena);
}
